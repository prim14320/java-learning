...
public class StudentSystem {
    ...
    private static final String QUERYSTUDENT = "3";
    private static final String UPDATESTUDENT = "4";
    private static final String EXIT = "5";
    private static ArrayList<Student> student = new ArrayList<>();
    //静态代码块初始化学生列表
    static{
        student.add(new Student("20230101","张三",18,"中国"));
        student.add(new Student("20230102","李四",19,"中国"));
        student.add(new Student("20230103","王五",20,"中国"));
        student.add(new Student("20230104","赵六",21,"中国"));
    }
    public static void main(String[] args) {
        ...
        loop :while (flag) {//2.指定位置跳出循环
            ...
            switch (choice) {
                case ADDSTUDENT -> addStudent(student);
                case DELETESTUDENT -> deleteStudent(student);
                case QUERYSTUDENT -> queryStudent(student);
                case UPDATESTUDENT -> updateStudent(student);
                case EXIT -> {
